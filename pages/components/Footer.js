...
export default function Footer({ children }) {
  return (
    ...
    >
      <div className="row border border-1 border-primary">
        <div
          className={`container-fluid text-center ${styles.footerBackground}`}
        >
          <div className="row mb-5 pt-5">
            <div className="text-left col-lg-4 col-md-4 col-sm-6 col-12 mb-3">
              <h4>Ashly Thomas Abraham</h4>
              <p className="indent-8">
                Something about me. Something about me. Some thing about me.
                Some thing about me. Something about me. Some thing about me.
                Some thing about me. Something about me. Some thing about me.
                Some thing about me.
              </p>
            </div>
              ...
              <ul>
                ...
                <li className="mt-3 hover:uppercase">
                  ...
                  <span className={`${styles.telephone}`}>
                    <a href="tel:+971-508570803">(+971)-508570803</a>
                  </span>
                </li>
              </ul>
            </div>
        ...
        <div
          className={`container-fluid text-center ${styles.copyrightBackground}`}
        >
